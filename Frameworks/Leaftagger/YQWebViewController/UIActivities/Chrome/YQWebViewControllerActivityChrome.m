//
//  YQWebViewControllerActivityChrome.h
//
...
@implementation YQWebViewControllerActivityChrome

- (NSString *)activityTitle {
	return NSLocalizedStringFromTable(@"Open in Chrome", @"YQWebViewController", nil);
}
