...
#import "YQWebViewControllerActivityChrome.h"
...
- (void)viewWillAppear:(BOOL)animated {
    NSAssert(self.navigationController, @"YQWebViewController needs to be contained in a UINavigationController. If you are presenting YQWebViewController modally, use YQModalWebViewController instead.");
...
- (UIBarButtonItem *)backBarButtonItem {
    if (!_backBarButtonItem) {
        _backBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"YQWebViewController.bundle/YQWebViewControllerBack"]
...
- (UIBarButtonItem *)forwardBarButtonItem {
    if (!_forwardBarButtonItem) {
        _forwardBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"YQWebViewController.bundle/YQWebViewControllerNext"]
                                                                 style:UIBarButtonItemStylePlain
                                                                target:self
...
- (void)actionButtonTapped:(id)sender {
    ...
    if (url != nil) {
        NSArray *activities = @[[YQWebViewControllerActivitySafari new], [YQWebViewControllerActivityChrome new]];
...
- (void)doneButtonTapped:(id)sùender {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"LeaftaggerCloseFolitagWebViewNotification" object:self userInfo:nil];
    // It may be useful in other places.
